...
object AirportEndpoints {
  ...
  val findAll: Endpoint[String, (Int, Int), (StatusCode, HttpErrorResponse), List[AirportDto], Any] =
    base.get
  ...
  val searchByName: Endpoint[String, String, (StatusCode, HttpErrorResponse), List[AirportDto], Any] =
    base.get
      .securityIn(auth.bearer[String]())
  ...
  val findByIata: Endpoint[String, String, (StatusCode, HttpErrorResponse), AirportDto, Any] =
    base.get
      .securityIn(auth.bearer[String]())
  ...
  val findCountry: Endpoint[String, String, (StatusCode, HttpErrorResponse), CountryDto, Any] =
    base.get
      .securityIn(auth.bearer[String]())
  ...
  val findByCountry
      : Endpoint[String, (String, Int, Int), (StatusCode, HttpErrorResponse), List[AirportDto], Any] =
    endpoint.get
      .securityIn(auth.bearer[String]())
  ...
  val create
      : Endpoint[String, CreateAirportRequest, (StatusCode, HttpErrorResponse), (AirportDto, String), Any] =
    base.post
      .securityIn(auth.bearer[String]())
  ...
  val update
      : Endpoint[String, (String, UpdateAirportRequest), (StatusCode, HttpErrorResponse), AirportDto, Any] =
    base.put
      .securityIn(auth.bearer[String]())
